= Restaurant Managment System - Developer Guide
...
|`* *` |Manager |view employees  |know which one of my employees are working today
...
2.  RMS shows the list of items in the menu
3.  User informs the menu item and the quantity they wish to order
4.  RMS put that item and its quantity in the order
5.  Repeat step 1 to 4 until user confirm the order
6.  RMS acknowledge the order and add it to the system
+
Use case ends.
...
+
2a2. RMS returns the list of items searched by the command the user entered
+
Return to step 3.
...
2.  RMS displays a message telling user the (three) ways he/she can update the menu
...
+
3a2. RMS displays the existing menu list
+
3a3. User looks for the INDEX of the particular item to be deleted and deletes the item
+
3a4. RMS deletes the food item from the existing list
+
Use case ends.
...
+
3b2. RMS shows the list of items with that menu name
+
3b3. User looks for the INDEX of the particular item to be deleted and deletes the item
+
3b4. RMS deletes the food item from the existing list
+
Use case ends.
...
+
3c2. RMS adds the entered menu to the existing menu list
+
Use case ends.
